...
query = conversation_id:1394699198382043136

replies=[]
for tweet in tweepy.Paginator(client.search_recent_tweets, q='to:'+name, result_type='recent', timeout=999999).items(1000):
