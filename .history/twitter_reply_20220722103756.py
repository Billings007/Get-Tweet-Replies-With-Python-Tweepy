...
replies=[]
for tweet in tweepy.Paginator(client.search_recent_tweets, query=query, tweet_fields=['context_annotations', 'created_at'],user_fields=['author_id'], expansions='author_id', max_results=100):
